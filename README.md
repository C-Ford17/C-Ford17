...
| 🍔 **Restaurant Ordering App** | 🎟️ **Events App** |
|:---:|:---:|
| Sistema de pedidos listo para producción con integración de códigos QR.<br>![Vue.js](https://img.shields.io/badge/Vue.js-35495E?style=flat-square&logo=vuedotjs&logoColor=4FC08D) ![Node.js](https://img.shields.io/badge/Node.js-339933?style=flat-square&logo=nodedotjs&logoColor=white)<br>[🔎 Ver Código](https://github.com/C-Ford17/restaurante-pedidos) | Aplicación completa para la gestión y reserva de eventos.<br>![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=nextdotjs&logoColor=white) ![TailwindCSS](https://img.shields.io/badge/Tailwind_CSS-38B2AC?style=flat-square&logo=tailwind-css&logoColor=white)<br>[🔎 Ver Código](https://github.com/C-Ford17/eventos-app) |

| 💼 **Sales System** | 👥 **Talent Platform** |
|:---:|:---:|
| Sistema de gestión de ventas completo con reportes y facturación.<br>![Angular](https://img.shields.io/badge/Angular-DD0031?style=flat-square&logo=angular&logoColor=white) ![.NET](https://img.shields.io/badge/.NET-512BD4?style=flat-square&logo=dotnet&logoColor=white)<br>[🔎 Ver Código](https://github.com/C-Ford17/sales-system) | Plataforma para conectar talento con oportunidades (Talent Match Pro).<br>![Next.js](https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=nextdotjs&logoColor=white) ![TailwindCSS](https://img.shields.io/badge/Tailwind_CSS-38B2AC?style=flat-square&logo=tailwind-css&logoColor=white)<br>[🔎 Ver Código](https://github.com/C-Ford17/Talent-Plataform) |

</div>

### 🔬 Otros Intereses
También exploro el mundo de la automatización y DevOps:
- **MLOps Pipeline Inteligente**: [Ver Repositorio](https://github.com/C-Ford17/mlops-pipeline-inteligente) (Python, Docker, MLflow)
...
*"Transformando requerimientos en código funcional."* 🚀
